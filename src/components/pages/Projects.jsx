    ...
    return (
      <div>
        ...
        <div className="container row row-cols-1 row-cols-md-2 lg-3">
            ...
            <h3 className="text-center"> Gamer's Paradise </h3>
                <img  class="card-img-top"  src="/blank-placeholder.jpeg" alt="Card image cap"></img>
                <div >
                </div>
            </a>

            <a href = "" class = "card shadow-sm pt-3 mb-5 bg-white rounded" >
            <h3 className="text-center"> Quotaku </h3>
                <img  class="card-img-top"  src="/quotaku.png" alt="Card image cap"></img>
                <div >
                </div>
            </a>
